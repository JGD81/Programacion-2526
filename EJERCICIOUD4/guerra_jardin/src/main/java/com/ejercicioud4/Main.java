...
public class Main {
    public static void main(String[] args) {
       ...
       //Instanciar DAOs
        ...
        cambiosGnomo.put("edad", 27);
        cambiosGnomo.put("nivelCascarrabias", 2);
         
         //Se devuelve true si los datos se han actualizado
         boolean gnomoActualizado = gnomoDAO.update(8, cambiosGnomo);
         
         //Mostramos los datos del gnomo actualizado
         System.out.println("Actualizado: " + gnomoActualizado);
         System.out.println("Después del update: " + gnomoDAO.findById(8));
        ...
        */
         ...
         */
         ...
         System.out.println(daoGnomo.findById(10));
         
         
        //Método delete()
         boolean gnomoEliminado = daoGnomo.delete(10);
         
         //Imprimir resultados
         System.out.println("Eliminado: " + gnomoEliminado);
         System.out.println("Nuevo total: " + daoGnomo.count());
         System.out.println("Buscar eliminado: " + daoGnomo.findById(10));
        ...
        */
         ...
         * // Prueba del ´metodo calcularEnergíaRefunfunioTotal
         ...
         int idGnomo = 8; // ID que quieres probar
